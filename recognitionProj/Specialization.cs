    ...
    public class Specialization
    {
        ...
        public Specialization(int insId, string type, int numStu,
                              ...
                              int numberLecturers, int numAssisLecturer, int numOtherTeachers,
                               int color, double ratio ,int numPhdHolders, int? practicalHours, int? theoreticalHours)
        {
            _insId = insId;
            _type = type;
            _numStu = numStu;
        ...
        public override string ToString()
        {
            return $"{_type} {_numStu} {_numProf} {_numAssociative} " +
                   ...
                   $"{_numOtherTeachers}  {_color} {_numPhdHolders} {_practicalHours} {_theoreticalHours}";
        }
    }
}
