...
public class Verifier
{
    ...
    public void HumanitarianBachelorRatio(Specialization spec)
    {
        ...
        double x;
            ...
            if (spec.Type == "Humanitarian Bachelor")
            {
                ...
                spec.Ratio = spec.NumStu / x;
                if (spec.NumStu / x < 35)//this color is green, meaning the specialization meets the ratio
                    spec.Color = 2;
                else if (spec.NumStu / x <= (35 + 0.2 * 35))//this color is orange, meaning the specialization is close to meeting the ratio
                    spec.Color = 1;
                else
                    spec.Color = 0;//this color is red, meaning the specialization does not meet the ratio
            }
    ...
    public void HighDiplomaRatio(Specialization spec) 
    {
            ...
            if (spec.Type == "High Diploma")
            {
                ...
                {
                    double studentToStaffRatio = (float)spec.NumStu / totalStaff;
                    spec.Ratio = studentToStaffRatio; 
